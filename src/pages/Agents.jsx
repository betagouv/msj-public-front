      ...
      && (
        <>
          <div className="sm:col-span-2">
            <h3 className="text-xs mb-0 font-medium text-msj-blue uppercase mb-1">Nom du service</h3>
            <p className="text-md font-bold mb-0">{agent.organization_name}</p>
          </div>
          <div className="sm:col-span-2">
            <h3 className="text-xs mb-0 font-medium text-msj-blue uppercase mb-1">Mon CPIP référent</h3>
            <p className="text-md font-bold mb-0">{`${agent.first_name} ${agent.last_name}`}</p>
          </div>
          <div className="sm:col-span-1">
            <h3 className="text-xs mb-0 font-medium text-msj-blue uppercase mb-1">Email</h3>
            <a className="text-md font-bold mb-0" href="mailto:johan.goncalves@coleurope.eu">{agent.email}</a>
          </div>
        </>
      )}
          {!loading && !agent
